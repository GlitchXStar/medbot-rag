      ...
      >
        ...
        <div className="rounded-3xl bg-white/[0.03] border border-white/[0.06] p-8 backdrop-blur-sm">
          ...
          <button
            type="button"
            onClick={() => googleLogin()}
            className="w-full h-[46px] flex items-center justify-center gap-2.5 rounded-xl bg-white/[0.05] border border-white/[0.08] text-[14px] font-medium text-text-primary hover:bg-white/[0.08] hover:-translate-y-[1px] transition-all duration-200 mb-6"
          >
